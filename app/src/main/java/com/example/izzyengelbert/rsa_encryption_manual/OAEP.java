package com.example.izzyengelbert.rsa_encryption_manual;
...
/**
 * Created by izzyengelbert on 12/1/2017.
 * source code : https://github.com/mbakkar/OAEP/blob/master/src/bakkar/mohamed/oaep/OAEP.java
 */
...
public class OAEP {
    ...
    /*public static void main(String[] args) throws Exception {
        ...
        System.out.println(myMessage.length+new String("SHA-256 MGF1").length()+myMessage.length + 32 + 32 + 1);
